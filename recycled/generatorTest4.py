...
#   bot5 = Bottom("bmJeans", "gray", {"summer"}, "wellfit")
  top1 = Top("bf", "green", {"summer"}, "baggy")
  top2 = Top ("bm","blue", {"summer"}, "tight")
  top3 = Top( "Pacsun","red", {"summer", "spring"}, "tight")
  top4 = Top("bm", "white", {"summer", "spring"}, "tight")
  top5 = Top("long", "green",{"summer"},"well-fit")
  bot1 = Bottom("chuu", "black", {"summer", "fall"}, "baggy")
  bot2 = Bottom("jean", "lightBlue", {"summer"}, "well-fit")
  bot3 = Bottom("vjean", "blue", {"summer"}, "baggy")
  ...
  user_preferences = ["red", "gray", "green", "black"]
